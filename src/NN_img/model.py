...
from config import TRANSFORMS_TRAIN, TRANSFORMS_TEST, DATASET_TRAIN_PATH, BATCH_SIZE, DATASET_NUM_WORKERS
...
if __name__ == "__main__":
    ...
    training_data = ID_Dataset(DATASET_TRAIN_PATH, transforms=TRANSFORMS)
