...
from config import TRANSFORMS_TRAIN, DATASET_TRAIN_PATH, BATCH_SIZE, DATASET_NUM_WORKERS
from dataset import ID_Dataset_train
...
if __name__ == "__main__":
    ...
    print("This result ", result, "target", example_targets)
